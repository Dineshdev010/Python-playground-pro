...
export const navItems = [
  ...
  { to: "/blog", icon: FileText, label: "Blog", emoji: "📝" },
  { to: "/projects", icon: FolderKanban, label: "Projects", emoji: "🗂️" },
  ...
  { to: "/career-roadmap", icon: Briefcase, label: "Career Roadmap", emoji: "🛣️" },
